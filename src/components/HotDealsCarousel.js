...
const HotDealsCarousel = () => {
  ...
  return (
    <div className="bg-white px-[10vw] lg:px-10 scroll-mt-[10vh]" id="hotdeals">
      <h1 className="text-3xl md:text-3xl lg:text-5xl text-slate-700 text-left ml-[6%] mr-[4%] lg:mr-[52%] pt-[0.5em] pb-[2%] md:pb-0">
        Акции
      </h1>
